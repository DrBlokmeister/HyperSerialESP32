...
* `STATUS_LED_PIN` - Optional pin for a status LED indicating serial activity. Example: `-DSTATUS_LED_PIN=15`. When enabled, the LED breathes slowly with a 2‑second period and blinks up to 10 Hz while frames are forwarded.
